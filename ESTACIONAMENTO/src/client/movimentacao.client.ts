...
class MovimentacaoClient {
  ...
  public async listAll(): Promise<Movimentacao[]> {
    try {
      return (
        await this.axiosMovimentacao.get<Movimentacao[]>(`/lista`)
      ).data;
    } catch (error: any) {
      return Promise.reject(error.response);
    }
  ...
  public async findByAbertas(): Promise<Movimentacao[]> {
    try {
      return (
        await this.axiosMovimentacao.get<Movimentacao[]>("/abertas")
      ).data;
    } catch (error: any) {
      return Promise.reject(error.response);
    }
  ...
  public async cadastrar(movimentacao: Movimentacao): Promise<string> {
    try {
      return (
        await this.axiosMovimentacao.post("", movimentacao)
      ).data;
    } catch (error: any) {
      return Promise.reject(error.response);
    }
  ...
  public async editar(
    ...
    try {
      return (
        await this.axiosMovimentacao.put(`/${id}`, movimentacao)
      ).data;
    } catch (error: any) {
      return Promise.reject(error.response);
    }
  ...
  public async fecharMovimentacao(id: number): Promise<Recibo> {
    try {
      return (
        await this.axiosMovimentacao.put<Recibo>(`/saida/${id}`)
      ).data;
    } catch (error: any) {
      return Promise.reject(error.response);
    }
  ...
  public async deletar(id: number): Promise<string> {
    try {
      return (
        await this.axiosMovimentacao.delete(`/${id}`)
      ).data;
    } catch (error: any) {
      return Promise.reject(error.response);
    }
